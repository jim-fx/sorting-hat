const data: DataSet = {
	description: 'Josies Hogwarts Quiz',
	questions: [
		{
			description: 'Welchem Haus gehört Nymphadora Tonks an? ',
			answers: ['Gryffindor ', 'Ravenclaw ', 'Hufflepuff ', 'Slytherin '],
			correct: 2
		},
		{
		...
		{
			description:
				'Welcher Satz muss gesagt werden, um die Karte des Rumtreibers unleslich zu machen? ',
			answers: [
				'Missetat begangen ',
