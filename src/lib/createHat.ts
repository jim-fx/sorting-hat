...
export default async function (): Promise<GLTF> {
	...
	const colMap = tLoader.load('textures/SortingHat_col.png');
	const normalMap = tLoader.load('textures/SortingHat_normal.png');
	const roughMap = tLoader.load('textures/SortingHat_rough.png');
